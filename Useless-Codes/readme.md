...
| **[create_contact_sheets](create_contact_sheets.sh)** | Create StyleSheets from a Video. | `~/Documents/Codes` | `bash` | No Preview |
| **[create_contact_sheets_images](create_contact_sheets_images.sh)** | Create StyleSheets from a Directory of images. | `~/Documents/Codes` | `bash` | No Preview |
...
| **[remove-special-char](./remove-special-char.py)** | Remove all special Characters like emojis ets from all files in dirs and subdirs. | `~/Documents/Codes` | `Bash` | No Preview |
